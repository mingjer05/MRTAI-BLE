...
const APP_VERSION = "2.2 (Dynamic Naming Support)";
console.log("App loaded: v" + APP_VERSION);
...
// Show version in terminal on load
window.addEventListener('DOMContentLoaded', () => {
    setTimeout(() => {
        logMsg(`🚀 MRTAI Controller v${APP_VERSION}`);
        logMsg(`💡 Ready to control or configure.`);
    }, 500);
});
...
if (setNameBtn) {
    setNameBtn.addEventListener('click', async () => {
        console.log("setNameBtn clicked!");
